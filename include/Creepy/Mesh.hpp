...
namespace Creepy{
    ...
    struct Mesh{
        public:
            ...
            void Draw(const vk::CommandBuffer commandBuffer, const vk::PipelineLayout pipelineLayout, const vk::DescriptorSet uniformDescSet, const glm::mat4& modelTransformMatrix);
